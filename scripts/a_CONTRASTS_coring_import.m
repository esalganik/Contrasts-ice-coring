...
projectRoot = pwd;
rootFolder = fullfile(projectRoot, "data", "raw");
...
outputFolder = fullfile(projectRoot, "data", "processed");
if ~isfolder(outputFolder)
    mkdir(outputFolder);
end
outputFile = fullfile(outputFolder, "core_data_imported.mat");
save(outputFile, 'T_all');
