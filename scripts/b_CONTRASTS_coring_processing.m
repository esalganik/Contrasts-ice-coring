...
inputFolder  = fullfile(projectRoot, "data", "processed");
outputFolder = fullfile(projectRoot, "data", "final");

if ~isfolder(outputFolder)
    mkdir(outputFolder);
end

INFILE_IMPORTED   = fullfile(inputFolder, "core_data_imported.mat");
OUTFILE_PROCESSED = fullfile(outputFolder, "core_data_processed.mat");
...
outXlsx = fullfile(outputFolder, "core_data_final.xlsx");
